...
exports.create = (req, res) => {
    ...
    let HelperOptions2 ={
        ...
        subject : "Your order on BookTown - Resell & Explore was successful",
        text : "Hello " + req.profile.name + ", \n\nYou have successfully made purchase of Rs. " + req.body.order.amount + "on BookTown - Resell & Explore. Please check your dashboard to track the status of your order.\n\nRegards, \nBookTown - Resell & Explore"
    };
