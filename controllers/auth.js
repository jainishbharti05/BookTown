...
exports.signup = async(req, res) => {
    ...
    let HelperOptions ={
        ...
        to : user.email,
        subject : "Welcome to BookTown - Resell & Explore",
        text : "Hello " + user.name + ", \n\nWelcome to BookTown - Resell & Explore. This is a fully functional e-commerce app built on MERN stack along with payment gateway. \nAny suggestions are always welcome. \n\nRegards, \nJainish Bharti"
    };
